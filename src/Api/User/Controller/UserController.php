...
class UserController extends AbstractController
{
    ...
    private function getRoleHumanReadable(User $user): ?string
    {
        ...
        if (in_array(Role::LIBRARIAN, $user->getRoles(), true)) {
            return RoleHumanReadable::LIBRARIAN;
        }

        if (in_array(Role::READER, $user->getRoles(), true)) {
            return RoleHumanReadable::READER;
        }
